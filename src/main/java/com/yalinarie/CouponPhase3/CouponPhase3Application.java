...
// @EnableJpaRepositories(basePackages = "com.yalinarie.CouponPhase3",
// entityManagerFactoryRef = "emf")
// @EnableAutoConfiguration(exclude = { DataSourceAutoConfiguration.class })
// public class CouponPhase3Application extends SpringBootServletInitializer {
...
public class CouponPhase3Application {
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(CouponPhase3Application.class, args);
